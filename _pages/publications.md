...
2020
=====
1. **Minh N. H. Nguyen**, Shashi Raj Pandey, Kyi Thar, Nguyen H. Tran, Mingzhe Chen, Walid Saad, Choong Seon Hong, "Distributed and Democratized Learning: Philosophy and Research Challenges," *Accepted in IEEE Computational Intelligence Magazine*. [Link Paper](https://arxiv.org/abs/2003.09301)
...
3. Canh Dinh, Nguyen H. Tran, **Minh N. H. Nguyen**, Choong Seon Hong, Wei Bao, Albert Zomaya, Vincent Gramoli, "Federated Learning over Wireless Networks: Convergence Analysis and Resource Allocation," *arXiv:1910.13067*, 2019. *Submitted to IEEE/ACM Transactions on Networking (Accepted)* [Link Paper](https://arxiv.org/abs/1910.13067)
4. Le, Tra Huong Thi, Nguyen H. Tran, Yan Kyaw Tun, **Minh N. H. Nguyen**, Shashi Raj Pandey, Zhu Han, and Choong Seon Hong. "An Incentive Mechanism for Federated Learning in Wireless Cellular network: An Auction Approach." arXiv preprint arXiv:2009.10269 (2020). [Link Paper](https://arxiv.org/abs/2009.10269)
5. **Minh N. H. Nguyen**, Nguyen H. Tran, Yan Kyaw Tun, Zhu Han, Choong Seon Hong, "Toward Multiple Federated Learning Services Resource Sharing in Mobile Edge Networks" *Submitted to IEEE Transactions on Mobile Computing (Major Revision)*. [Link Paper](https://arxiv.org/abs/2011.12469) 
6. Shashi Raj Pandey, **Minh N. H. Nguyen**, Tri Nguyen Dang, Kyi Thar, Nguyen H. Tran, Zhu Han, Choong Seon Hong, "Distributed and Democratized Learning: Philosophy and Research Challenges,". [Link Paper](https://arxiv.org/abs/2012.00425)

2019
=====
1. Latif U. Khan, Nguyen H. Tran, Shashi Raj Pandey, Walid Saad, Zhu Han, **Minh N. H. Nguyen**, Choong Seon Hong, "Federated Learning for Edge Networks: Resource Optimization and Incentive Mechanism," *arXiv:1911.05642*, 2019. *Submitted to IEEE Communication Magazine (Accepted)* [Link Paper](https://arxiv.org/abs/1911.05642)
