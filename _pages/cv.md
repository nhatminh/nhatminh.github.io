...
* 03/2024-now: **Deputy Head of Department of Science, Technology, and International Cooperation**, VKU
  * In Charge of Research Program in Digital Science and Technology Institute (eSTI), VKU
...
6. "Class Label Conditioning Diffusion Model for Robust Brain Tumor MRI Synthesis", Submitted to IEEE Computational Intelligence Magazine, 2024 [TechRxiv](https://www.techrxiv.org/articles/preprint/Class_Label_Conditioning_Diffusion_Model_for_Robust_Brain_Tumor_MRI_Synthesis/24243829)
7. "A novel transformer-based software fault prediction using Syntactic Tree and Word Embedding", Submitted to Neural Computing and Applications
